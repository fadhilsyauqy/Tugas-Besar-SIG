        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Tambah Data Sebaran Titik Rawan Gempa Bumi</h6>
                </div>
                <div class="card-body">
                    <!-- Main content -->
                    <form class="form-horizontal style-form" style="margin-top: 10px;" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-2">
                            ...
                            <div class="col-sm-6">
                                <input name="nama_wilayah" id="nama_wilayah" type="text" class="form-control" required />
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label class="col-sm-2 col-sm-4 control-label" for="administratif">Status Administratif</label>
                            <div class="col-sm-6">
                                <input name="administratif" id="administratif" class="form-control" type="text" required />
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label class="col-sm-2 col-sm-4 control-label" for="ibukota">Ibukota</label>
                            <div class="col-sm-6">
                                <input name="ibukota" id="ibukota" class="form-control" type="text" required />
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label class="col-sm-2 col-sm-4 control-label" for="=luas_wilayah">Luas Wilayah</label>
                            <div class="col-sm-6">
                                <input name="luas_wilayah" id="=luas_wilayah" class="form-control" type="text" required />
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label class="col-sm-2 col-sm-4 control-label" for="latitude">Latitude</label>
                            <div class="col-sm-6">
                                <input name="latitude" id="latitude" class="form-control" type="text" required />
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label class="col-sm-2 col-sm-4 control-label" for="longitude">Longitude</label>
                            <div class="col-sm-6">
                                <input name="longitude" id="longitude" class="form-control" type="text" required />
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <label class="col-sm-2 col-sm-4 control-label" for="status_rawan">Status Rawan</label>
                            <div class="col-sm-6">
                                <input name="status_rawan" id="status_rawan" class="form-control" type="text" required />
                            </div>
                        </div>
